...
router.post('/:id/complete', taskController_1.completeTask); // Anyone can complete
// 3. Restricted Routes (Parent Only)
router.post('/:id/approve', (0, authController_1.restrictTo)('Parent'), taskController_1.approveTask);
router
    .route('/:id')
