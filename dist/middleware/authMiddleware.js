...
exports.protect = (0, express_async_handler_1.default)(async (req, res, next) => {
    ...
    if (!token) {
        return next(new applicationError_1.default('You are not logged in! Please log in to get access.', 401));
    }
    ...
    if (!currentUser) {
        return next(new applicationError_1.default('The user belonging to this token no longer exists.', 401));
    }
    ...
    if (currentUser.passwordChangedAt) {
        ...
        if (passwordChangedTimestamp > decoded.iat) {
            return next(new applicationError_1.default('User recently changed password! Please log in again.', 401));
        }
    }
